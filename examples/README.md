...
- `dem/Miyakejima_island.tif` — example DEM (GeoTIFF) used to test upload, processing, and export.
- `dem/Izu_Oshima.tif` — example DEM (GeoTIFF) used to test upload, processing, and export.
